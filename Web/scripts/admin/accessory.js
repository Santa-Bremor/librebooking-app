function AccessoryManagement(opts) {
    ...
    var editAccessory = function () {
        ...
        elements.editResponsibleUser.val(accessory.responsibleUserId || '');
    ...
    AccessoryManagement.prototype.addAccessory = function (id, name, quantity, responsibleUserId) {
        accessories[id] = {id: id, name: name, quantity: quantity, responsibleUserId: responsibleUserId};
    };
}
